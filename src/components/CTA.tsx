        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
              ...
              Agende agora uma análise gratuita e confidencial da situação da
              sua empresa. Nossos especialistas estão prontos para encontrar a
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                },
                {
                  icon: Mail,
                  label: 'E-mail',
                  value: 'priaara@gmail.com',
                },
                {
                  icon: MapPin,
                  label: 'Endereço',
                  value: 'QN 7 conjunto 5 - Riacho Fundo/DF',
                },
              ].map((item, index) => (
                <motion.div
                  key={item.label}
              ...
              <div className="relative bg-gradient-to-br from-slate-900/95 to-slate-950/95 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-8 overflow-hidden">
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full bg-slate-900/80 border border-slate-700 focus:border-yellow-500 rounded-xl px-4 py-3 text-white outline-none transition-all resize-none"
                  />
                ...
                <div className="mt-6 pt-6 border-t border-slate-800/80 relative z-10">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    {[
                      ...
                      >
                        <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-yellow-400 to-amber-500">
                          {badge.value}
                        </div>
