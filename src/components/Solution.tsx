...
import { FileSearch, Gavel, Handshake, Rocket, ChevronRight, ArrowRight } from 'lucide-react';
...
const steps = [
  {
    ...
    description: 'Analisamos todas as dívidas da sua empresa — bancárias, tributárias, trabalhistas e fornecedores. Mapeamos cada passivo e identificamos as melhores oportunidades de redução.',
  },
  {
    icon: Gavel,
    number: '02',
    title: 'Estratégia Jurídica Personalizada',
    description: 'Nossos advogados especialistas elaboram uma estratégia sob medida para o seu caso, utilizando as melhores ferramentas jurídicas disponíveis: recuperação judicial, renegociação e litígio estratégico.',
  },
  {
    icon: Handshake,
    number: '03',
    title: 'Negociação com Credores',
    description: 'Negociamos diretamente com bancos, Receita Federal, INSS e fornecedores. Nossa experiência e relacionamento nos permitem alcançar reduções de até 90% sobre o valor original da dívida.',
  },
  {
    icon: Rocket,
    number: '04',
    title: 'Empresa Livre para Crescer',
    description: 'Com as dívidas reduzidas e renegociadas, sua empresa volta a respirar. Você pode reinvestir no negócio, contratar, expandir e construir um futuro próspero sem o peso do passado.',
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-3xl mx-auto">
            Nosso método comprovado em mais de 110 casos de sucesso segue um processo 
            estruturado e transparente que garante os melhores resultados para sua empresa.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10">COMECE AGORA SUA RECUPERAÇÃO</span>
